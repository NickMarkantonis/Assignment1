...
int main() 
{
    ...
    {
        float r1, g1, b1;
        float rdis1, gdis1, bdis1;

        r1 = color1[0];
        g1 = color1[1];
        b1 = color1[2];

        rdis1 = (color2[0] - color1[0]) * 2 / w;
        gdis1 = (color2[1] - color1[1]) * 2 / w;
        bdis1 = (color2[2] - color1[2]) * 2 / w;
        ...
        for (int i = 0; i < h/2; i++) 
        {
            ...
            for (int j = w/2; j < w; j++) {
                color pixel_color = color(r * r + r1 * r1, g * g + g1 * g1, b * b + b1 * b1);
                write_color(fout, pixel_color);
